import {  Box, GridItem, Grid, TabPanel, TabPanels, Tabs, TabList, Tab } from "@chakra-ui/react";
...
export default function Follow() {
  ...
  return (
    <Grid
      ...
      w={"full"}
    >
      <GridItem p={5} position={"fixed"} borderRight={"1px"} height={"full"} borderColor={"white"} gridArea="1 / 1 / 7 / 2">
        <Navbar />
      </GridItem>
